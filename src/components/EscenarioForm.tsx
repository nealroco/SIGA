    ...
    <form action={formAction} className="card" style={{ padding: 24, maxWidth: 720 }}>
      ...
      <div className="form-grid">
        <div className="field">
          ...
          <input id="nombre" name="nombre" className="input" placeholder="Coliseo Mayor…" required />
          {fe.nombre && <span className="err">{fe.nombre}</span>}
        </div>
        <div className="field">
          <label htmlFor="tipo">Tipo</label>
          <select id="tipo" name="tipo" className="select" defaultValue="">
      ...
      <div className="form-grid">
        <div className="field">
          ...
          <input id="direccion" name="direccion" className="input" placeholder="Dirección…" />
          {fe.direccion && <span className="err">{fe.direccion}</span>}
        </div>
        <div className="field">
          <label htmlFor="capacidad">Capacidad</label>
          <input id="capacidad" name="capacidad" className="input" type="number" min={0} step="any" />
