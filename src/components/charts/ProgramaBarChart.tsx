...
export default function ProgramaBarChart({ data }: { data: { programa: string; count: number }[] }) {
  return (
    <div style={{ width: "100%", height: Math.max(180, data.length * 34) }}>
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} layout="vertical" margin={{ top: 4, right: 16, bottom: 4, left: 4 }}>
          ...
          <YAxis type="category" dataKey="programa" width={140} tick={{ fontSize: 12, fill: "#0b1538" }} axisLine={false} tickLine={false} />
